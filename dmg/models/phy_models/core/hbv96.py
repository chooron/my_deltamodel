...
#     """
#     HBV-96 model single step calculation.
#     """
#     # --- 1. Snowpack and Liquid Water (S1, S2) ---
#     # Climate drivers
...
#     # Update S2 (Liquid Water in Snow)
#     S2 = S2 + flux_rf + flux_melt - flux_refr
    
#     # Infiltration and Excess
#     # whc*S1 is the capacity of snow pack to hold liquid water
#     flux_in = infiltration_3(flux_rf + flux_melt, S2, whc * S1)
#     flux_se = excess_1(S2, whc * S1)
    
#     S2 = torch.clamp(S2 - flux_in - flux_se, min=nearzero)
    
#     # --- 2. Soil Moisture (S3) ---
#     # Capillary rise from S4 to S3
#     flux_cf = capillary_1(cflux, S3, fc, S4)
#     # Evapotranspiration
#     flux_ea = evap_3(lp, S3, fc, PET)
#     # Recharge to S4
#     flux_r = recharge_2(beta, S3, fc, flux_in + flux_se)
    
#     # Update S3
#     S3 = S3 + flux_in + flux_se + flux_cf - flux_ea - flux_r
#     S3 = torch.clamp(S3, min=nearzero)
    
#     # --- 3. Upper Zone Reservoir (S4) ---
#     S4 = S4 + flux_r - flux_cf
#     # Interflow/Runoff (Non-linear)
#     flux_q0 = interflow_2(k0, S4, alpha)
#     # Percolation to Lower Zone
#     flux_perc = percolation_1(perc, S4)
    
#     S4 = torch.clamp(S4 - flux_q0 - flux_perc, min=nearzero)
    
#     # --- 4. Lower Zone Reservoir (S5) ---
#     S5 = S5 + flux_perc
#     # Baseflow (Linear)
#     flux_q1 = baseflow_1(k1, S5)
#     S5 = torch.clamp(S5 - flux_q1, min=nearzero)
