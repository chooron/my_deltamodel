...
def topmodel_step(
    ...
    flux_qof = torch.clamp(flux_qof, min=0.0, max=P)
    ...
    flux_qex = torch.clamp(flux_qex, min=0.0, max=flux_peff)
    ...
    flux_qv = interflow_10(S1_tmp, kd, threshold_s1, capacity_s1, nearzero=nearzero)
