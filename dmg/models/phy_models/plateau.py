...
from dmg.models.hydromodel.flux.evap import evap_4
from dmg.models.hydromodel.flux.capillary import capillary_2
from dmg.models.hydromodel.flux.saturation import saturation_1
...
# Compile
_plateau_production_step = torch.compile(_plateau_production_step_impl)
...
class Plateau(UnifyV2):
    ...
    def _run_model(
        ...
        for t in range(n_steps):
            flux_pie, flux_qpgw, flux_ea, S1, S2 = _plateau_production_step(
                P_seq[t], PET_seq[t], S1, S2,
                fmax, dp, sumax, lp, p_coeff, c_rise, kp,
                nearzero
            )
