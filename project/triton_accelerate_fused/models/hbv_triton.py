...
try:
    from project.triton_accelerate_fused.models.hbv_triton_core import hbv_step_triton
...
# 尝试导入融合 Triton 版本
try:
    from project.triton_accelerate_fused.models.hbv_triton_fused import hbv_step_fused
    FUSED_AVAILABLE = True
except ImportError:
    FUSED_AVAILABLE = False

# 导入 autograd 版本
from project.triton_accelerate_fused.models.hbv_triton_autograd import (
    hbv_step_pytorch,
    hbv_step_compiled,
)
