...
用法:
    python calibrate_common_parallel.py --model hbv96
"""
...
def parse_args():
    parser = argparse.ArgumentParser(description="并行率定 common 水文模型")
    parser.add_argument("--model", type=str, required=True, help="模型名称 (例如: hbv96)")
