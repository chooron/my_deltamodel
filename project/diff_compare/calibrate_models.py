...
def main(model_name):
    ...
    CONFIG_PATH = r"conf/config_dcommon_calibrate.yaml"
    with open(
        f"{proj_path}/project/diff_compare/conf/config_dcommon_calibrate.yaml", "r"
    ) as f:
        config = yaml.safe_load(f)
    config["delta_model"]["phy_model"]["model_name"] = model_name

    with open(
        f"{proj_path}/project/diff_compare/conf/config_dcommon_calibrate.yaml", "w"
    ) as f:
