...
# 引入通量计算函数
from dmg.models.hydromodel.flux.interception import interception_2
from dmg.models.hydromodel.flux.evap import evap_1
from dmg.models.hydromodel.flux.saturation import saturation_2
from dmg.models.hydromodel.flux.split import split_1
from dmg.models.hydromodel.flux.capillary import capillary_2
...
# Compile the single step function
_hillslope_production_step = torch.compile(_hillslope_production_step_impl)
...
class Hillslope(UnifyV2):
    ...
    def _run_model(
        ...
        for t in range(n_steps):
            flux_qses, flux_qhgw, flux_ea, S1, S2 = _hillslope_production_step(
