...
NEWZEALAND2_PARAMS_BOUNDS = {
    ...
    "sfc_frac": [0.05, 0.95],   # Field capacity as fraction of maximum soil moisture [-]
...
def newzealand2_step(
    ...
    flux_qtf = torch.clamp(flux_qtf, min=0.0, max=P)
    ...
    flux_qse = torch.clamp(flux_qse, min=0.0, max=flux_qtf)
