...
# 引入通量计算函数
from dmg.models.hydromodel.flux.snowfall import snowfall_1
from dmg.models.hydromodel.flux.rainfall import rainfall_1
from dmg.models.hydromodel.flux.melt import melt_1
from dmg.models.hydromodel.flux.interception import interception_1
from dmg.models.hydromodel.flux.evap import evap_1, evap_3
from dmg.models.hydromodel.flux.saturation import saturation_3
from dmg.models.hydromodel.flux.percolation import percolation_2
...
from dmg.models.hydromodel.unithydro.uh_tri_3 import DplTri3
...
# Explicit Compilation (mode="reduce-overhead" is optimal for small kernels)
_flexis_production_step = torch.compile(
    _flexis_production_step_impl
)
_flexis_routing_step = torch.compile(
    _flexis_routing_step_impl
)
...
class Flexis(UnifyV2):
    ...
    def _run_model(
        ...
        for t in range(n_steps):
            Qsim, S4, S5 = _flexis_routing_step(
