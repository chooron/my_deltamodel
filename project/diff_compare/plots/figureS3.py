...
JULIA_HBV96_PARAMS = ['tt', 'tti', 'ttm', 'cfr', 'cfmax', 'whc', 'cflux', 'fc', 'lp', 'beta', 'k0', 'alpha', 'perc', 'k1']
...
def load_baseline_data():
    ...
    baseline_params = JULIA_HBV96_PARAMS
    target_params = list(HBV96_PARAMS_BOUNDS.keys())
    idx_map = []
...
def plot_comparison_ridgeline():
    ...
    if filtered:
        ...
        fig.legend(
            ...
            bbox_to_anchor=(0.5, top_margin + 0.04),
    ...
    save_path = figures_dir / f"Figure_S3_N_Comparison_Ridgeline_{MODEL_NAME}.png"
