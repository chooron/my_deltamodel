...
from ..marrmot.interception import interception_3
from ..marrmot.evap import evap_8, evap_9, evap_10, evap_5
...
def us1_step(
    ...
    flux_eusei = torch.clamp(flux_eusei, min=0.0, max=P)
    ...
    flux_rg = torch.clamp(flux_rg, min=0.0, max=p_eff)
    ...
    flux_qse = torch.clamp(flux_qse, min=0.0, max=qin_s2)
