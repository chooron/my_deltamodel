...
AVAILABLE_MODELs = ["hymod", "hbv96", "xinanjiang", "collie1"]
...
def main(model_name, nmul):
    ...
    CONFIG_PATH = r"conf/config_ablation_nmul_invkge.yaml"
    with open(
        f"{proj_path}/project/diff_compare/conf/config_ablation_nmul_invkge.yaml", "r"
    ) as f:
    ...
    with open(
        f"{proj_path}/project/diff_compare/conf/config_ablation_nmul_invkge.yaml", "w"
    ) as f:
