...
# 引入通量计算函数
from dmg.models.hydromodel.flux.evap import evap_1, evap_6, evap_5
...
from dmg.models.hydromodel.flux.interflow import interflow_9
from dmg.models.hydromodel.flux.baseflow import baseflow_1

# 引入单位线: uh_4_full (Full Triangular)
from dmg.models.hydromodel.unithydro.uh_tri_4 import DplTri4
...
# Compile
_newzealand2_production_step = torch.compile(_newzealand2_production_step_impl)
...
class Newzealand2(UnifyV2):
    ...
    def _run_model(
        ...
        for t in range(n_steps):
            flux_q_total, flux_ea, S1, S2 = _newzealand2_production_step(
                P_seq[t],
                PET_seq[t],
                S1,
                S2,
